...
#ifndef FLATBUFFERS_GENERATED_MPIMESSAGE_HOROVOD_WIRE_H_
#define FLATBUFFERS_GENERATED_MPIMESSAGE_HOROVOD_WIRE_H_
...
enum MPIDataType {
  MPIDataType_DYNET_MPI_UINT8 = 0,
  MPIDataType_DYNET_MPI_INT8 = 1,
  MPIDataType_DYNET_MPI_UINT16 = 2,
  MPIDataType_DYNET_MPI_INT16 = 3,
  MPIDataType_DYNET_MPI_INT32 = 4,
  MPIDataType_DYNET_MPI_INT64 = 5,
  MPIDataType_DYNET_MPI_FLOAT32 = 6,
  MPIDataType_DYNET_MPI_FLOAT64 = 7,
  MPIDataType_DYNET_MPI_BOOL = 8,
  MPIDataType_MIN = MPIDataType_DYNET_MPI_UINT8,
  MPIDataType_MAX = MPIDataType_DYNET_MPI_BOOL
};
...
inline flatbuffers::Offset<MPIRequest> CreateMPIRequest(
    ...
    MPIDataType tensor_type = MPIDataType_DYNET_MPI_UINT8,
...
inline flatbuffers::Offset<MPIRequest> CreateMPIRequestDirect(
  ...
  return horovod::wire::CreateMPIRequest(
      _fbb,
      request_rank,
      request_type,
      tensor_type,
...
inline flatbuffers::Offset<MPIResponse> CreateMPIResponseDirect(
  ...
  return horovod::wire::CreateMPIResponse(
      _fbb,
      response_type,
...
#endif  // FLATBUFFERS_GENERATED_MPIMESSAGE_HOROVOD_WIRE_H_
